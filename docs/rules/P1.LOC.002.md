...
directories — `packs/`, `services/`, `modules/` — every immediate child
that holds source files must carry an `AGENTS.md` or `CLAUDE.md`.
...
- Care **always** once your repo uses a `packs/` or `services/` layout with
  more than one sibling slice.
